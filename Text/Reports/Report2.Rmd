...
The dataset is freely available on the Kaggle. It can be located at @diamondskaggle. There is also a .csv version available in the 'Data' folder in the GitHub repository for this project. 
