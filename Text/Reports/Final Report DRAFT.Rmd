...
We see that the mean price of diamonds does differ for different levels of 'cut' (table \@ref(tab:cutmean)). However, we see that improved cut does not necessarily lead to increased price.
...
Table \@ref(tab:colmean) shows the mean prices for the different levels of the 'color' variable and it is clear that they vary. Interestingly the diamonds with the two highest color quality show the lowest mean price.
