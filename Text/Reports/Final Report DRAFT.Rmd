...
(figure \@ref(fig:LDApricerank)) shows some evidence of the three groups being seperable with a linear function. There is still some overlap as well as some points (or groups of points) that seem to be far removed from the rest of the data. We will now see how this LDA performs as a classifier 
