...
Using a Hotelling's T-test we will test the equality of mean vectors of the lowest and highest level of each categorical variable. We might expect the diamonds with lower quality cut, color and clarity to differ significantly to diamonds with high quality cut, colour and clarity. We will also check the assumption of the equality of covariance matrices for each test.


```{r}
(hotelling.test(subset(diamonds, cut == "Fair")[,-(2:4)], subset(diamonds, cut == "Premium")[,-(2:4)]))

(testCov(subset(diamonds, cut == "Fair")[,-(2:4)], subset(diamonds, cut == "Premium")[,-(2:4)]))
```
...
(testCov(subset(diamonds, color == "J")[,-(2:4)], subset(diamonds, color == "D")[,-(2:4)]))
```
...
(testCov(subset(diamonds, clarity == "I1")[,-(2:4)], subset(diamonds, clarity == "IF")[,-(2:4)]))
```
